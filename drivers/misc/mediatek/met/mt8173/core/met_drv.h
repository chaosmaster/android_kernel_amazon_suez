...
int __attribute__ ((weak)) met_tag_start(unsigned int class_id, const char *name);

int __attribute__ ((weak)) met_tag_end(unsigned int class_id, const char *name);
...
int __attribute__ ((weak)) met_tag_dump(unsigned int class_id,
					const char *name, void *data, unsigned int length);
