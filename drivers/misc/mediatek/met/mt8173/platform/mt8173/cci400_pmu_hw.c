...
static const char cci400_desc[] = "mediatek,CCI400";
static void __iomem *cci400_iobase;
static unsigned char cci400_rev;
...
static int cci400_pmu_hw_probe(void)
{
	...
	if ((id[0] != 0x0d) || (id[1] != 0xf0) || (id[2] != 0x05) || (id[3] != 0xb1)) {
		return -1;
	}
