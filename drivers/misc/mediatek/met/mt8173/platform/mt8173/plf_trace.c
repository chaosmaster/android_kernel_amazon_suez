...
{
	char buf[70 * HVALUE_SIZE];	/* max cnt == 70 */
...
void ms_th(unsigned long long timestamp, unsigned char cnt, unsigned int *value)
{
	...
	switch (cnt) {
	case 1:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT1, MS_TH_VAL MS_TH_UD_VAL1);
		break;
	case 2:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT2, MS_TH_VAL MS_TH_UD_VAL2);
		break;
	case 3:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT3, MS_TH_VAL MS_TH_UD_VAL3);
		break;
	case 4:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT4, MS_TH_VAL MS_TH_UD_VAL4);
		break;
	case 5:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT5, MS_TH_VAL MS_TH_UD_VAL5);
		break;
	case 6:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT6, MS_TH_VAL MS_TH_UD_VAL6);
		break;
	case 7:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT7, MS_TH_VAL MS_TH_UD_VAL7);
		break;
	case 8:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT8, MS_TH_VAL MS_TH_UD_VAL8);
		break;
	case 9:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT9, MS_TH_VAL MS_TH_UD_VAL9);
		break;
	case 10:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT10, MS_TH_VAL MS_TH_UD_VAL10);
		break;
	case 11:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT11, MS_TH_VAL MS_TH_UD_VAL11);
		break;
	case 12:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT12, MS_TH_VAL MS_TH_UD_VAL12);
		break;
	case 13:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT13, MS_TH_VAL MS_TH_UD_VAL13);
		break;
	case 14:
		MET_PRINTK(MS_TH_FMT MS_TH_UD_FMT14, MS_TH_VAL MS_TH_UD_VAL14);
		break;
	default:
		printk("Warnning!MET thermal Cnt Not support: %d\n", cnt);
		break;
	}
}
...
void ms_dramc(unsigned long long timestamp, unsigned char cnt, unsigned int *value)
{
	switch (cnt) {
	case 4:
		MET_PRINTK(MS_DRAMC_UD_FMT, MS_DRAMC_UD_VAL);
		break;
	}
}
