...
#define LVDS_TX0_REG_BASE        ddp_regbase_va[DISP_MODULE_LVDSTX0]
#define LVDS_TX1_REG_BASE        ddp_regbase_va[DISP_MODULE_LVDSTX1]
...
#define LVDSTX0_BASE				LVDS_TX0_REG_BASE
#define LVDSTX1_BASE				LVDS_TX1_REG_BASE
